...
namespace Utilities.Events
{
    ...
    /// </summary>
    /// <inheritdoc/>
    /// <typeparam name="TObject">The type for the target and source objects, e.g. <see cref="GameObject"/>.</typeparam>
    public class EventBus<TBaseEvent, TObject> : EventBus<TBaseEvent>
    {
        ...
        /// <returns>If the event was raised immediately, returns true if the event was consumed with <see cref="EventBus{TBaseEvent}.ConsumeCurrentEvent"/>.</returns>
        ...
        /// <param name="source">The source object for this event.</param>
        /// <typeparam name="TEvent">The type of event to raise.</typeparam>
        /// <returns>Returns true if the event was consumed with <see cref="EventBus{TBaseEvent}.ConsumeCurrentEvent"/>.</returns>
        ...
        {
            private static readonly Dictionary<EventBus<TBaseEvent, TObject>,
                TargetedEventListeners<TEvent>> Listeners =
                new Dictionary<EventBus<TBaseEvent, TObject>, TargetedEventListeners<TEvent>>();
            ...
            public static TargetedEventListeners<TEvent> Get(EventBus<TBaseEvent, TObject> eventBus)
            {
            ...
            {
                Listeners.Remove((EventBus<TBaseEvent, TObject>)eventBus);
            }

            private readonly EventBus<TBaseEvent, TObject> _eventBus;
            ...
            private TargetedEventListeners(EventBus<TBaseEvent, TObject> eventBus)
            {
                _eventBus = eventBus;
            }
            ...
            private class DerivedQueuedEvent : QueuedEvent
            {
                ...
                {
                    var bus = (EventBus<TBaseEvent, TObject>)eventBus;
